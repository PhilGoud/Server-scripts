...
TOKEN="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"  # Telegram bot token
CHAT_ID="XXXXXXXXXXXXXXXXX"  # Telegram chat ID

# Directories, destinations, and names in the format:
# "source_directory|destination_directory|name|check_source"
JOBS=(
